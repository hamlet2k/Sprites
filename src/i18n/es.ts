...
const es: MessageTree = {
  ...
  collection: {
    ...
    lost: 'Perdidos',
    mastered: 'Maestría',
    statsFilterLabel: 'Filtros de estado',
    presetFilterLabel: 'Filtros rápidos en partida',
    filterOwnedTitle: 'Mostrar todos los espíritus',
    filterAvailableTitle: 'Solo Listos (puedes traer sin polvo)',
    filterLostTitle: 'Solo Perdidos (necesitan polvo para traer)',
    filterMissingTitle: 'Solo Falta (nunca conseguidos)',
    filterMasteredTitle: 'Solo con Maestría',
    ...
    needFilter: 'Necesita (Falta + Perdidos)',
    needFilterShort: 'Necesita',
    levelUpFilter: 'Subir nivel',
    filtersLabel: 'Filtros',
    expandFilters: 'Mostrar todos los filtros',
  ...
  help: {
    ...
    openSourceBody:
      'Sprite Squad es gratis y de código abierto (MIT). El código, incidencias y contribuciones están en GitHub. Es un proyecto de fans — no relacionado con Epic Games.',
    openSourceButton: 'Ver en GitHub',
    openSourceLinkHint: 'Abre el repositorio de GitHub en una pestaña nueva',
