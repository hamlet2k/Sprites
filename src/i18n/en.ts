...
const en: MessageTree = {
  ...
  collection: {
    ...
    lost: 'Lost',
    mastered: 'Mastered',
    statsFilterLabel: 'Status filters',
    presetFilterLabel: 'In-game quick filters',
    filterOwnedTitle: 'Show all sprites',
    filterAvailableTitle: 'Show Ready only (can bring free)',
    filterLostTitle: 'Show Lost only (needs dust to bring)',
    filterMissingTitle: 'Show Missing only (never collected)',
    ...
    needFilter: 'Needed',
    needFilterShort: 'Needed',
    levelUpFilter: 'Level up',
  ...
  voice: {
    micTitle: 'Hold to speak a sprite name',
    overlayTitle: 'Sprite voice lookup',
    listening: 'Listening…',
    listeningHint: 'Say a sprite name, then release',
    processing: 'Looking up…',
    noSpeech: 'No speech detected. Hold the mic and try again.',
    noMatch: 'Could not match that to a sprite. Try again.',
    noPlayer: 'Pick your seat first so we know whose collection to check.',
    unsupported: 'Voice recognition is not supported in this browser.',
    permissionDenied: 'Microphone permission denied. Allow mic access to use voice lookup.',
    error: 'Voice error: {msg}',
    youSaid: 'Heard: “{heard}”',
    forPlayer: 'For {name}',
    masteredYes: 'Mastered',
    masteredNo: 'Not mastered',
    summaryMissing: 'Missing — never collected.',
    summaryReadyUnmastered: 'Ready to bring — still needs mastery.',
    summaryReadyMastered: 'Ready to bring — already mastered.',
    summaryLostUnmastered: 'Lost — needs dust to re-summon; not mastered yet.',
    summaryLostMastered: 'Lost — needs dust to re-summon (mastered).',
    dismiss: 'Got it',
    tryAgain: 'Hold the mic and say the name again.',
  },
  help: {
